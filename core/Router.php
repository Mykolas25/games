...
class Router
{
    ...
    public function reflect($class, $method)
    {
        $refClass = new ReflectionClass($class); // https://www.php.net/manual/en/class.reflectionclass.php
    ...
    public function resolve()
    {
        ...
        // dump($requestMethod,$requestUri);die();
    ...
    public function matchUriSegments(array $requestUriSegments, array $routeUriSegments)
    {
        $match = [];
